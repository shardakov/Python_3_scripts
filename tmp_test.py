...
class TestClass(object):
    ...
    def parse_args(self):
        ...
        parser.add_argument('dicts', type=str, nargs='+',
                            help='one or more dict name, "all" for all dicts in config')
        parser.add_argument('--config', '-c', default='config.yaml', type=str, nargs='?')
        parser.add_argument('--name_base', '-n', default='ap_brandsafe_type', type=str, nargs='?')
